...
public class LZ77 extends JFrame {
    ...
    private List<LZ77Tupel> list = new ArrayList<LZ77Tupel>();
    ...
    public LZ77() {
        ...
        btnNewButton_2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                if(text!="")
                {
                    ...
                    list=LZ77Fun.compress(text);
                    for (LZ77Tupel t : list) {
            
                       temp2 +="<"+t.getIndex()+" "+t.getLength()+" "+ t.getString()+">";
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                LZ77Fun.compress(textPane.toString());
            }
        });
        button.setEnabled(false);
